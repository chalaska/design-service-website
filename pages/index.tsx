        ...
        <div className={`w-full max-w-2xl transition-opacity duration-300 ${isFocused && !isComplete ? 'relative z-20' : ''}`}>
          ...
          <div className={`transition-opacity duration-300 ${isFocused && !isComplete ? 'opacity-30' : 'opacity-100'}`}>
            ...
            <div className="mt-16 text-center halaska-method">
              <div className="bg-white rounded border border-gray-100 p-8">
                ...
                <div className="text-left space-y-4 border-t border-gray-100 pt-6">
                  <div>
                    <h4 className="font-semibold text-gray-700 mb-2">Discovery & Strategy</h4>
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-700 mb-2">Design & Iteration</h4>
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-700 mb-2">Delivery & Support</h4>
              ...
              <div className="bg-white rounded border border-gray-100 p-8">
                ...
                <div className="mb-8">
                  <div className="text-5xl font-bold text-gray-900 mb-2">
                    From $6,000<span className="text-xl text-gray-500">/month</span>
                  </div>
                ...
                <div className="mt-8 pt-6 border-t border-gray-100">
                  ...
                  <button
                    ...
                    className="bg-gray-800 hover:bg-gray-900 text-white font-semibold py-3 px-6 rounded transition-all"
                  >
                    Discuss Your Needs
                  </button>
                </div>
            ...
            <div className="mt-16 recent-projects">
              <h3 className="text-2xl font-semibold text-gray-600 mb-6 text-center">Recent Projects</h3>
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                {recentProjects.slice(0, projectsToShow).map((project, index) => (
                  <button
                    ...
                    className="bg-white rounded border border-gray-100 hover:border-gray-200 transition-colors group text-left p-4"
                  >
                    <div className={`${project.color} rounded h-24 flex items-center justify-center mb-3 group-hover:scale-105 transition-transform`}>
              ...
              {projectsToShow < recentProjects.length && (
                <div className="text-center mt-8">
                  <button
                    ...
                    className="bg-white hover:bg-gray-100 text-gray-600 hover:text-gray-800 font-semibold py-3 px-6 rounded border border-gray-200 transition-all"
                  >
                    Load more projects
                  </button>
                </div>
            ...
            <div className="mt-16 contact-form">
              <div className="bg-white rounded border border-gray-100 overflow-hidden transition-all duration-500">
                {!showContactForm ? (
                  /* Contact Card */
                  <div className="p-8 text-center">
                    ...
                    <button
                      ...
                      className="bg-gray-800 hover:bg-gray-900 text-white font-semibold py-4 px-8 rounded transition-all"
                    >
                      Get in touch
                    </button>
                  </div>
                  ...
                  <div className="p-8">
                    ...
                    <form className="space-y-6" onSubmit={async (e) => {
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                          ...
                          <input
                            ...
                            name="name"
                            required
                            className="w-full p-4 border border-gray-200 rounded focus:border-gray-400 focus:outline-none transition-colors bg-gray-50 focus:bg-white font-light"
                      ...
                      <div>
                        ...
                        <select name="project_type" required className="w-full p-4 border border-gray-200 rounded focus:border-gray-400 focus:outline-none transition-colors bg-gray-50 focus:bg-white font-light">
                      ...
                      <div>
                        ...
                        <textarea
                          ...
                          rows={4}
                          required
                          className="w-full p-4 border border-gray-200 rounded focus:border-gray-400 focus:outline-none transition-colors bg-gray-50 focus:bg-white font-light resize-none"
                      ...
                      <div>
                        ...
                        <select name="timeline" required className="w-full p-4 border border-gray-200 rounded focus:border-gray-400 focus:outline-none transition-colors bg-gray-50 focus:bg-white font-light">
